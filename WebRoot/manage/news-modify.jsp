			...
			<form action="UpdateNews" method="post" >
				<table class="form">
					...
					<tr>
						...
						<td>
							<input type="hidden" name="enid" value="<%=n.getEn_id() %>"/>
							<input type="text" class="text" name="title" value="<%=n.getEn_title() %>" />
						</td>
					</tr>
					<tr>
						<td class="field">新闻内容：</td>
						<td><textarea name="content"><%=n.getEn_content() %></textarea></td>
					</tr>
					<tr>
						<td></td>
