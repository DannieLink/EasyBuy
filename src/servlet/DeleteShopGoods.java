...
public class DeleteShopGoods extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public DeleteShopGoods() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		}else
		{
			...
			int delresult=sd.delShopGoods(epid, euid);
			if(delresult>0){
				request.getRequestDispatcher("ShowShopGoods").forward(request, response);
			}
		}
	}
